      ...
      <div className="footer-inner">
        <div className="footer-top">
          ...
          <div>
            ...
            <div className="footer-links">
              <Link to="/">Home</Link>
              <Link to="/collections/all">Our Book</Link>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">
            &copy; {new Date().getFullYear()} DearBook &middot; dearbook.ca &middot; All rights reserved.
          </p>
...
function PaymentIcon({name}) {
  return <span className="footer-payment-icon">{name}</span>;
}
